...
export const REISSUE = {
    ...
    data: { assetId: '7sP5abE9nGRwZxkgaEXgkQDZ3ERBcm9PLHixaUE5SYoT', quantity: 123456790, reissuable: true },
};

export const BURN = {
    type: TRANSACTION_TYPE.BURN,
    data: { assetId: '7sP5abE9nGRwZxkgaEXgkQDZ3ERBcm9PLHixaUE5SYoT', amount: 123456790 },
};
...
export const PACKAGE = [ISSUE, TRANSFER, REISSUE, BURN, LEASE, CANCEL_LEASE, ALIAS];
