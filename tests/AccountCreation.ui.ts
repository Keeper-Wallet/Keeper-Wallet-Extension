...
describe('Account creation', function () {
    ...
    async function deleteAllAccounts() {
        while (true) {
            ...
            let activeWalletEl: WebElement[] = await form.findElements(
                By.xpath(
                    "//div[contains(@class, '-wallet-activeWallet')]" + "//div[contains(@class, '-wallet-accountName')]"
                )
            );
            ...
            await this.driver
                .wait(until.elementLocated(By.xpath("//div[contains(@class, '-accountInfo-deleteButton')]")), this.wait)
                .click();
    ...
    describe('Import accounts using keystore file', function () {
        describe('validation', () => {
            it('keeps "Continue" button disabled until both keystore file is selected and password is entered');
        });
        ...
        describe('file parsing and decryption', () => {
            ...
            afterEach(async function () {
                await this.driver.findElement(By.xpath("//div[contains(@class, '-menu-arrowBackIcon')]")).click();
            });
                    ...
                    .then((accountGroups) =>
                        Promise.all(
                            accountGroups.map((group) =>
                                Promise.all([
                                    group
                                        .findElement(By.css('[data-testid="accountsGroupLabel"]'), this.wait)
                                        .getText(),
                                    group
                                        .findElements(By.css('[data-testid="accountCard"]'), this.wait)
                                        .then((accountCards) =>
                                            Promise.all(
            ...
            it('can decrypt the correct keeper keystore file', async function () {
                ...
                await this.driver.findElement(By.css('[data-testid="passwordInput"]')).sendKeys('xHZ7Zaxu2wuncWC');
            ...
            it('can decrypt the correct exchange keystore file', async function () {
                ...
                await this.driver.findElement(By.css('[data-testid="passwordInput"]')).sendKeys('N72r78ByXBfNBnN#');
                await this.driver.findElement(By.css('[data-testid="submitButton"]')).click();
        ...
        describe('actual import', function () {
            ...
            describe('when no accounts exist', function () {
                it.skip('allows to select and import all accounts', async function () {
                    ...
                    expect(await extractAccountCheckboxesFromDOM.call(this)).to.have.deep.ordered.members([
                        { name: 'test2', address: '3PCj4z3TZ1jqZ7A9zYBoSbHnvRqFq2uy89r', selected: true },
                        { name: 'test', address: '3Mxpw1i3ZP6TbiuMU1qUdv6vSBoSvkCfQ8h', selected: true },
                        { name: 'test3', address: '3Mxpfxhrwyn4ynCi7WpogBQ8ccP2iD86jNi', selected: true },
                        { name: 'test4', address: '3MWxaD2xCMBUHnKkLJUqH3xFca2ak8wdd6D', selected: true },
                    ]);

                    await this.driver
                        .findElement(By.css('input[type="checkbox"][value="3Mxpfxhrwyn4ynCi7WpogBQ8ccP2iD86jNi"]'))
                        .click();

                    await this.driver
                        .findElement(By.css('input[type="checkbox"][value="3PCj4z3TZ1jqZ7A9zYBoSbHnvRqFq2uy89r"]'))
                        .click();

                    expect(await extractAccountCheckboxesFromDOM.call(this)).to.have.deep.ordered.members([
                        { name: 'test2', address: '3PCj4z3TZ1jqZ7A9zYBoSbHnvRqFq2uy89r', selected: false },
                        { name: 'test', address: '3Mxpw1i3ZP6TbiuMU1qUdv6vSBoSvkCfQ8h', selected: true },
                        { name: 'test3', address: '3Mxpfxhrwyn4ynCi7WpogBQ8ccP2iD86jNi', selected: false },
                        { name: 'test4', address: '3MWxaD2xCMBUHnKkLJUqH3xFca2ak8wdd6D', selected: true },
                    ]);
                    ...
                    expect(
                        await this.driver
                            ...
                            .then((accountNames) => Promise.all(accountNames.map((accName) => accName.getText())))
                    ...
                    expect(JSON.parse(seedUtils.decryptSeed(vault, DEFAULT_PASSWORD))).to.deep.equal([
                        {
            ...
            describe('when some, but not all accounts already exist', function () {
                it.skip('allows to select only unexisting accounts', async function () {
                    ...
                    expect(await extractAccountCheckboxesFromDOM.call(this)).to.have.deep.ordered.members([
                        { name: 'test2', address: '3PCj4z3TZ1jqZ7A9zYBoSbHnvRqFq2uy89r', selected: true },
                        { name: 'test', address: '3Mxpw1i3ZP6TbiuMU1qUdv6vSBoSvkCfQ8h', selected: null },
                        { name: 'test3', address: '3Mxpfxhrwyn4ynCi7WpogBQ8ccP2iD86jNi', selected: true },
                        { name: 'test4', address: '3MWxaD2xCMBUHnKkLJUqH3xFca2ak8wdd6D', selected: null },
                    ]);
            ...
            describe('when all accounts exist', function () {
                it.skip('does not allow selecting anything and shows the "Skip" button', async function () {
                    ...
                    expect(await extractAccountCheckboxesFromDOM.call(this)).to.have.deep.ordered.members([
                        { name: 'test2', address: '3PCj4z3TZ1jqZ7A9zYBoSbHnvRqFq2uy89r', selected: null },
                        { name: 'test', address: '3Mxpw1i3ZP6TbiuMU1qUdv6vSBoSvkCfQ8h', selected: null },
                        { name: 'test3', address: '3Mxpfxhrwyn4ynCi7WpogBQ8ccP2iD86jNi', selected: null },
                        { name: 'test4', address: '3MWxaD2xCMBUHnKkLJUqH3xFca2ak8wdd6D', selected: null },
                    ]);
            ...
            describe('when the user already has an account with the same name, but different address', function () {
                it('adds suffix to the name', async function () {
                    ...
                    await App.initVault.call(this);
                    await Network.switchTo.call(this, 'Testnet');
                    await CreateNewAccount.importAccount.call(this, 'test', 'this is the seed for the test account');
                    ...
                    expect(await extractAccountCheckboxesFromDOM.call(this)).to.have.deep.ordered.members([
                        { name: 'test2', address: '3PCj4z3TZ1jqZ7A9zYBoSbHnvRqFq2uy89r', selected: true },
                        { name: 'test (1)', address: '3Mxpw1i3ZP6TbiuMU1qUdv6vSBoSvkCfQ8h', selected: true },
                        { name: 'test3', address: '3Mxpfxhrwyn4ynCi7WpogBQ8ccP2iD86jNi', selected: true },
                        { name: 'test4', address: '3MWxaD2xCMBUHnKkLJUqH3xFca2ak8wdd6D', selected: true },
                    ]);
                ...
                it('increments the number in suffix if it already exists', async function () {
                    ...
                    await App.initVault.call(this);
                    await Network.switchTo.call(this, 'Testnet');
                    await CreateNewAccount.importAccount.call(this, 'test', 'this is a seed for the test account');
                    await this.driver
                        .wait(
                            until.elementLocated(By.xpath("//div[contains(@class, '-assets-addAccount')]")),
                            this.wait
                    ...
                    expect(await extractAccountCheckboxesFromDOM.call(this)).to.have.deep.ordered.members([
                        { name: 'test2', address: '3PCj4z3TZ1jqZ7A9zYBoSbHnvRqFq2uy89r', selected: true },
                        { name: 'test (2)', address: '3Mxpw1i3ZP6TbiuMU1qUdv6vSBoSvkCfQ8h', selected: true },
                        { name: 'test3', address: '3Mxpfxhrwyn4ynCi7WpogBQ8ccP2iD86jNi', selected: true },
                        { name: 'test4', address: '3MWxaD2xCMBUHnKkLJUqH3xFca2ak8wdd6D', selected: true },
                    ]);
