...
export class AssetScriptInfo extends React.PureComponent<ISetScriptInfo> {
    ...
    render() {
        ...
        return <div>
            <div className="font600 tag1 basic500 margin-min"><Trans i18nKey='transactions.assetScriptWarningHeader'>Warning: actions can block transactions with your asset</Trans></div>
            <div className="tag1 basic500 margin-main"><Trans i18nKey='transactions.assetScriptWarningDescription'>We do not recommend you submit script transactions unless you are an experienced user.</Trans></div>
