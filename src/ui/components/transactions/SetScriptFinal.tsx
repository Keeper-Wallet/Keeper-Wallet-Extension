...
@translate('extension')
export class SetScriptFinal extends React.PureComponent {
        ...
        if (isApprove) {
            return <div>
                ...
                <div className="basic500">
                    {isSend ? <Trans i18nKey='sign.transactionSendSetScript'>You have created a script transaction</Trans> : null}
                    {!isSend ? <Trans i18nKey='sign.transactionConfirmSetScript'>You have approved a Set Script transaction</Trans> : null}
                </div>
            </div>
        }
