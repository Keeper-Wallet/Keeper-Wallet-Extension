...
import { Attachment, Balance, Button, BUTTON_TYPE, DateFormat } from '../../ui';
import { getAmount, getFee, getTransferAmount } from './parseTx';
...
const Transfers = ({ transfers, totalAmount, count = MIN_COUNT }) => {
    ...
    const data = transfers.slice(0, count).map(({ recipient, amount }) => {
