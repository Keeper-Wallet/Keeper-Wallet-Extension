...
export class SetScriptInfo extends React.PureComponent<ISetScriptInfo> {
    ...
    render() {
        ...
        return <div>
            ...
            <div className="tag1 basic500 margin-main"><Trans i18nKey='transactions.scriptWarningDescription'>We do not recommend you submit script transactions unless you are an experienced user. Errors can lead to permanent loss of access to your account.</Trans></div>
