...
export type ImportKeystoreProfiles = Record<ImportKeystoreNetwork, { accounts: ImportKeystoreAccount[] }>;
...
export function ImportKeystoreChooseAccounts({ allNetworksAccounts, profiles, onSkip, onSubmit }: Props) {
        ...
        () =>
            new Set(
                Object.values(profiles)
                    .reduce((accounts, profile) => accounts.concat(profile.accounts), [] as ImportKeystoreAccount[])
                                                        ...
                                                        {existingAccount && (
                                                            ...
                                                            >
                                                                <Trans
                                                                    ...
                                                                    values={{ existingName: existingAccount.name }}
                                                                />
                                                            </div>
                                                        )}
                                                    </div>
