...
export function NftInfo() {
  ...
  const nftInfo = usePopupSelector(state => state.nfts?.[params.assetId]);
  ...
  const nftUrl = nft
    ? (networkCode === '88811' || networkCode === '88817') &&
      contractAddress &&
      tokenId
      ? `https://explorer.unit0.dev/token/${contractAddress}/instance/${tokenId}`
