  ...
  return (
    <div data-testid="importForm" className={styles.root}>
      ...
      <div className={styles.separatorBtns}>
        <Button
          data-testid="createNewAccountMultichainBtn"
          view="submit"
          onClick={async () => {
        ...
        >
          {t('import.createNewMultichain')}
        </Button>
        <Button
          data-testid="createNewAccountWavesBtn"
          view="simple"
          onClick={async () => {
            ...
            const networkCode =
              ...
              String(profileConfig?.chainId ?? '');

            await generateNewWalletItems(networkCode);
            navigate('/create-account');
          }}
        >
          {t('import.createNewWaves')}
        </Button>
      </div>
