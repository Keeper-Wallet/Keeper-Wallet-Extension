                ...
                <form className={styles.content} onSubmit={this.onSubmit}>
                    ...
                    <div className={`tag1 left basic500 marginTop3`}>
                        <Trans i18nKey="newAccount.passinfo">
                            The password you entered will be stored locally. If you change device or lose your password,
                            you will have to repeat the process of adding accounts to Waves Keeper. Waves does not store
                            your passwords.
                        </Trans>
                    </div>
                </form>
