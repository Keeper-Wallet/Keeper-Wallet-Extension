    ...
    <>
      ...
      >
        <AssetAmountInput
          ...
          assetOptions={swappableAssets.filter(asset => asset.id !== toAssetId)}
        ...
        <div className="modal cover">
          <div className="modal-form">
            ...
            <div className={styles.slippageToleranceModalTitle}>
              <Trans i18nKey="swap.slippageToleranceModalTitle" />
            </div>

            <p className={styles.slippageToleranceModalDescription}>
              <Trans i18nKey="swap.slippageToleranceModalDescription" />
            </p>
