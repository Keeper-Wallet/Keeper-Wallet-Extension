...
import { ExportKeystoreChooseAccounts, ExportKeystoreAccount } from './chooseAccounts';
...
export const ExportAccounts = connect(mapStateToProps)(function ExportAccounts({ allNetworksAccounts, onBack }: Props) {
    const [accountsToExport, setAccountsToExport] = React.useState<ExportKeystoreAccount[] | null>(null);
