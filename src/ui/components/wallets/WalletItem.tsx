...
export const WalletItem = ({
  ...
  const iconClass = cn(styles.accountIcon, {
  ...
  return (
    <div
      className={`${className} ${styles.inner} flex`}
    ...
    >
      ...
      <div className={`body1 ${styles.accountData}`}>
        <div className={`basic500 ${styles.accountName}`}>{account.name}</div>
      ...
      <div className={styles.controls}>
        ...
        <div
          ...
          className={`showTooltip ${iconClass}`}
        ></div>
