...
const userAgentRules: UserAgentRule[] = [
  ...
  ['kakaotalk', /KAKAOTALK\s([0-9._]+)/],
  ['samsung', /SamsungBrowser\/([0-9._]+)/],
  ['silk', /\bSilk\/([0-9._-]+)\b/],
  ['miui', /MiuiBrowser\/([0-9._]+)$/],
  ['beaker', /BeakerBrowser\/([0-9._]+)/],
  ['edge-chromium', /EdgA?\/([0-9._]+)/],
  [
    'chromium-webview',
    /(?!Chrom.*OPR)wv\).*Chrom(?:e|ium)\/([0-9._]+)(:?\s|$)/,
  ],
  ['chrome', /(?!Chrom.*OPR)Chrom(?:e|ium)\/([0-9._]+)(:?\s|$)/],
  ['phantomjs', /PhantomJS\/([0-9._]+)(:?\s|$)/],
  ['crios', /CriOS\/([0-9._]+)(:?\s|$)/],
  ['firefox', /Firefox\/([0-9._]+)(?:\s|$)/],
  ['fxios', /FxiOS\/([0-9._]+)/],
  ['opera-mini', /Opera Mini.*Version\/([0-9._]+)/],
  ['opera', /Opera\/([0-9._]+)(?:\s|$)/],
  ['opera', /OPR\/([0-9._]+)(:?\s|$)/],
  ['ie', /Trident\/7\.0.*rv:([0-9._]+).*\).*Gecko$/],
  ['ie', /MSIE\s([0-9._]+);.*Trident\/[4-7].0/],
  ['ie', /MSIE\s(7\.0)/],
  ['bb10', /BB10;\sTouch.*Version\/([0-9._]+)/],
  ['android', /Android\s([0-9._]+)/],
  ['ios', /Version\/([0-9._]+).*Mobile.*Safari.*/],
  ['safari', /Version\/([0-9._]+).*Safari/],
  ['facebook', /FBAV\/([0-9._]+)/],
  ['instagram', /Instagram\s([0-9._]+)/],
  ['ios-webview', /AppleWebKit\/([0-9._]+).*Mobile/],
  ['ios-webview', /AppleWebKit\/([0-9._]+).*Gecko\)$/],
  ['curl', /^curl\/([0-9._]+)$/],
